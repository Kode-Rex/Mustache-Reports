...
<html lang="en">
<head>
    <title>Code coverage report for es6/doc-utils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">es6/</a> doc-utils.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">85.57% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>83/97</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-yes">3336×</span>
<span class="cline-any cline-yes">3336×</span>
<span class="cline-any cline-yes">12232×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1112×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
DocUtils.defaults = {
	nullGetter(part) {
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if (part.module === "rawxml") {
			return "";
		}
...
&nbsp;
DocUtils.xml2str = <span class="fstat-no" title="function not covered" >function (xmlNode) {</span>
<span class="cstat-no" title="statement not covered" >	const a = new XMLSerializer();</span>
<span class="cstat-no" title="statement not covered" >	return a.serializeToString(xmlNode);</span>
};
&nbsp;
DocUtils.decodeUtf8 = <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >	try {</span>
<span class="cstat-no" title="statement not covered" >		if (s === undefined) { <span class="cstat-no" title="statement not covered" >return undefined; </span>}</span>
		// replace Ascii 160 space by the normal space, Ascii 32
<span class="cstat-no" title="statement not covered" >		return decodeURIComponent(escape(DocUtils.convertSpaces(s)));</span>
	}
	catch (e) {
<span class="cstat-no" title="statement not covered" >		const err = new Error("End");</span>
<span class="cstat-no" title="statement not covered" >		err.properties.data = s;</span>
<span class="cstat-no" title="statement not covered" >		err.properties.explanation = "Could not decode string to UTF8";</span>
<span class="cstat-no" title="statement not covered" >		throw err;</span>
	}
};
&nbsp;
DocUtils.encodeUtf8 = <span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >	return unescape(encodeURIComponent(s));</span>
};
&nbsp;
DocUtils.str2xml = <span class="fstat-no" title="function not covered" >function (str, errorHandler) {</span>
<span class="cstat-no" title="statement not covered" >	const parser = new DOMParser({errorHandler});</span>
<span class="cstat-no" title="statement not covered" >	return parser.parseFromString(str, "text/xml");</span>
};
&nbsp;
DocUtils.charMap = {
	"&amp;": "&amp;amp;",
