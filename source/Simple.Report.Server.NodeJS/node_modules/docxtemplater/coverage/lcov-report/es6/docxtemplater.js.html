...
<html lang="en">
<head>
    <title>Code coverage report for es6/docxtemplater.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">es6/</a> docxtemplater.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">90.36% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>75/83</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cstat-no" title="statement not covered" >			throw new Error("The constructor with parameters have been removed in docxtemplater 3.0, please check the upgrade guide.");</span>
		}
		this.compiled = {};
		this.modules = [];
		this.setOptions({});
	...
	loadZip(zip) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if (zip.loadAsync) {
<span class="cstat-no" title="statement not covered" >			throw new Error("Docxtemplater doesn't handle JSZip version &gt;=3, see changelog");</span>
		}
		this.zip = zip;
		this.updateFileTypeConfig();
		return this;
...
<span class="cstat-no" title="statement not covered" >			const content = this.zip.files[fileName].asText();</span>
<span class="cstat-no" title="statement not covered" >			xmlDocuments[fileName] = DocUtils.str2xml(content);</span>
<span class="cstat-no" title="statement not covered" >			return xmlDocuments;</span>
		}, {});
...
&nbsp;
		...
		this.templatedFiles.forEach((fileName) =&gt; {
			<span class="missing-if-branch" title="else path not taken" >E</span>if (this.zip.files[fileName] != null) {
...
<span class="cstat-no" title="statement not covered" >			this.zip.remove(fileName);</span>
<span class="cstat-no" title="statement not covered" >			const content = DocUtils.encodeUtf8(DocUtils.xml2str(this.xmlDocuments[fileName]));</span>
<span class="cstat-no" title="statement not covered" >			return this.zip.file(fileName, content, {});</span>
		});
		return this;
	}
	setData(data) {
